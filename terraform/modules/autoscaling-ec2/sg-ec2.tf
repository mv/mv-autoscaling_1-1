...
#   ping     = { from =    8, to=8   , protocol = "icmp", cidr = "0.0.0.0/0" } # echo_request: type=8, code=0
    ping_10  = { from =   -1, to=-1  , protocol = "icmp", cidr = "10.0.0.0/8"     }
    ping_172 = { from =   -1, to=-1  , protocol = "icmp", cidr = "172.16.0.0/12"  }
    ping_192 = { from =   -1, to=-1  , protocol = "icmp", cidr = "192.168.0.0/16" }
    ping_100 = { from =   -1, to=-1  , protocol = "icmp", cidr = "100.99.0.0/16"  }
  }
  egress = {
